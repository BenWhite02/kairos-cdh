...
var _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _dispatch, dispatch_fn, _a4;
...
var _client3, _result, _queries2, _options, _observers2, _combinedResult, _lastCombine, _lastResult, _observerMatches, _trackResult, trackResult_fn, _combineResult, combineResult_fn, _findMatchingObservers, findMatchingObservers_fn, _onUpdate, onUpdate_fn, _notify2, notify_fn2, _a10;
var QueriesObserver = (_a10 = class extends Subscribable {
...
}, _client3 = new WeakMap(), _result = new WeakMap(), _queries2 = new WeakMap(), _options = new WeakMap(), _observers2 = new WeakMap(), _combinedResult = new WeakMap(), _lastCombine = new WeakMap(), _lastResult = new WeakMap(), _observerMatches = new WeakMap(), _trackResult = new WeakSet(), trackResult_fn = function(result, matches) {
  ...
  if (this.hasListeners()) {
    ...
    const newResult = __privateMethod(this, _combineResult, combineResult_fn).call(this, newTracked, (_a12 = __privateGet(this, _options)) == null ? void 0 : _a12.combine);
...
var _client4, _currentResult2, _currentMutation, _mutateOptions, _updateResult, updateResult_fn, _notify3, notify_fn3, _a11;
